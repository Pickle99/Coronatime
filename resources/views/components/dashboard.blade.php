...
<header class="border-b-2 h-20 flex items-center justify-between">
           ...
           <div class="mx-5 border-r-2"></div>
             ...
             <div class="mt-4 items-center">
                 <form method="POST" action="/logout">
                     @csrf
                     <button class="mr-52 text-sm " type="submit"> Logout</button>
                 </form>
             </div>
    ...
    <div class="mx-52 mt-10">
        ...
        <div class="flex mt-10 h-10 border-b-2">
                <a href="/dashboard?page=worldwide" class="{{$page === 'worldwide' || is_null($page) ? 'font-bold border-b-4 border-black text-xl mr-20' : 'text-xl mr-20'}}" >Worldwide</a>
                <a href="/dashboard?page=country"  class="{{$page === 'country' ? 'font-bold border-b-4 border-black text-xl mr-20' : 'text-xl mr-20'}}"  >By country</a>
            </div>
    </div>
    <div>
