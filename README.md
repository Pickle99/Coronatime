...
- **[DrawSql diagram link](https://drawsql.app/redberry-22/diagrams/coronatime-diagram-assignment-2#)**
...
With HTTPS:
 ```https://github.com/RedberryInternship/coronatime-Luka-Ramishvili.git```
